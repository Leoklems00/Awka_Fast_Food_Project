...
with st.container(border=True):
    ...
    fig1 = px.bar(
        ...
        x='year',
        y='transaction_count',
        labels={'year': '', 'transaction_count': 'Sales Volume', 'year_label': 'Year'},
        color='year_label',
    ...
    fig1.update_layout(
        ...
        yaxis=dict(title='Sales Volume', showgrid=False, showline=False, zeroline=False, tickfont=dict(size=12)),
        bargap=0.2,
    )
